document.addEventListener('DOMContentLoaded', function () {
    ...
    if (savedTheme) {
        if (savedTheme === 'dark') {
            ...
            iconTheme.src = 'https://github.com/LouisOnraed/recette-de-grand-mere/blob/main/src/img/dark.png?raw=true'; // Change l'icône du bouton de changement de thème
        } else {
            ...
            iconTheme.src = 'https://github.com/LouisOnraed/recette-de-grand-mere/blob/main/src/img/light.png?raw=true'; // Change l'icône du bouton de changement de thème
        }
    }
